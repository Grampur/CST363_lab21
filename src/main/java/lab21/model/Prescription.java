...
public class Prescription {
	...
	@Override
	public String toString() {
		return "PrescriptionData [rxid=" + rxid + ", drugName=" + drugName + ", quantity=" + quantity + ", patient_id="
				+ patient_id + ", doctor_id=" + doctor_id + ", dateCreated=" + dateCreated + ", refills=" + refills
				+ ", fills=" + fills + "]";
	}
